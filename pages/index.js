...
export default function Home() {
  return (
    <div className={styles.home_container}>
      ...
      <p>I used to work in the wonderful world of public accounting. One day, I tried writing code to <HomePageLink linkObject={homePageLinks.automate} /> and I discovered the immense potential for technology to change the financial industry. I've been obsessed with the intersection of finance and technology ever since.</p>
      <p>Currently, I work on building fintech stuff at <HomePageLink linkObject={homePageLinks.employer} />.</p>
